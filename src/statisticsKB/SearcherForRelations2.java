...
import lucene.SearcherEntryRT;
import lucene.SearcherRedirect;
import util.ReaderFileConfig;

public class SearcherForRelations2 {
	/*
	...
	private SearcherEntryRT searcherRT;


	public SearcherForRelations2(ReaderFileConfig readerFileConfig) {
		try {
			...
			this.searcherRT = new SearcherEntryRT(readerFileConfig);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
